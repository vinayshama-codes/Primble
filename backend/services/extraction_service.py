...
_EXTRACT_PROMPT_PREFIX = (
    ...
    '  has_property_coverage: true if document mentions building limits, BPP (business personal property), commercial property, property premiums, COPE data, or location addresses with insured values.\n'
    '  has_auto_coverage: true if document mentions business auto, commercial auto, vehicle schedules, VINs, auto liability limits, fleet coverage, or any auto-related coverage.\n'
    ...
    '  has_umbrella: true if document mentions umbrella, excess liability, excess limits, attachment point, or self-insured retention above primary coverage.\n'
    ...
    '  is_contractor: true if document describes the insured as a contractor, subcontractor, general contractor, construction firm, or mentions construction trades (roofing, electrical, plumbing, excavation, demolition, etc.).\n'
    ...
    '  has_builders_risk: true if document mentions builders risk, property under construction, project value, anticipated completion date, or construction loan.\n'
    '  has_inland_marine: true if document mentions inland marine, floater, contractor\'s equipment, motor truck cargo, cargo in transit, installation floater, or scheduled mobile equipment.\n'
