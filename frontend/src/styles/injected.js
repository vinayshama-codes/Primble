...
_style.textContent = `
  ...
  .upgrade-modal-wide { max-width: 1000px !important; width: 96vw !important; }
  .upgrade-plan-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 18px; align-items: start; }
  @media (max-width: 900px) { .upgrade-plan-grid { grid-template-columns: 1fr; max-width: 420px; margin: 0 auto; } }
