        ...
        <div className="modal-inner">
          ...
          <div className="auth-google">
            <div style={{ borderRadius: "12px", width: "100%" }}>
              <GoogleLogin onSuccess={handleGoogleSuccess} onError={() => setError("Google sign-in failed")} size="large" text={mode === "signin" ? "signin_with" : "signup_with"} shape="rectangular" logo_alignment="left" width={400} />
            </div>
          </div>
